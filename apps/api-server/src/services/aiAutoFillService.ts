...
//       console.log("✅ Google AI API configured successfully!");
//     } else {
...
//       // For base64 images from frontend
...
//         console.warn("⚠️ Local file URI detected");
//         return "";
//       }

//       // ✅ For regular URLs - fetch and convert with retry
...
//     // Create a simple cache key from the image URL
//     if (imageUrl.startsWith("data:image")) {
//       // For base64, use the first 100 chars as key
...
//     try {
//       if (!base64Data || base64Data.length < 100) {
//         console.warn("⚠️ Image data too small or invalid");
//         return "";
//       }
...
//           console.warn("⚠️ OCR.space daily limit reached. Try again tomorrow.");
//         } else if (
//           errorMsg.includes("invalid") ||
//           errorMsg.includes("corrupt")
//         ) {
//           console.warn("⚠️ Invalid image data. Please try a different image.");
//         } else {
//           console.warn("⚠️ OCR failed:", errorMsg || "Unknown error");
//         }
//         return "";
//       }
//     } catch (error: any) {
//       if (error.name === "AbortError") {
//         console.error("❌ OCR.space timeout - request took too long");
//       } else {
//         console.error("❌ OCR.space error:", error.message);
//       }
//       return "";
...
//   private async analyzeWithGoogleAI(
//     text: string,
...
//             responseData = data;
//             break; // Stop loop on successful request
//           } else {
//             console.warn(
//               `⚠️ Model ${model} failed (${res.status}): ${data.error?.message}`,
//             );
//           }
//         } catch (error: any) {
...
//       // Extract text safely from stored responseData
//       const responseText =
...
//       deviceType = "ac";
//     else if (lowerText.includes("refrigerator") || lowerText.includes("fridge"))
...
//       deviceType = "laptop";
//     else if (lowerText.includes("fan")) deviceType = "fan";
//     else if (lowerText.includes("motor") || lowerText.includes("pump"))
//       deviceType = "motor";

//     let brand = "Samsung";
//     if (lowerText.includes("lg")) brand = "LG";
//     else if (lowerText.includes("samsung")) brand = "Samsung";
...
//     if (lowerText.includes("not cooling") || lowerText.includes("cooling")) {
//       problem = "Not cooling properly";
//     } else if (lowerText.includes("noise") || lowerText.includes("sound")) {
//       problem = "Making unusual noise";
...
//       // Step 1: Try OCR (with cache and retry)
//       const extractedText = await this.extractTextWithOCRspace(imageUrl);

//       // Step 2: If OCR succeeded
//       if (extractedText && extractedText.length > 10) {
//         console.log(`📝 OCR extracted ${extractedText.length} characters`);

//         // ✅ Check if text contains any repair-related keywords
...
//           console.log("ℹ️ Text does not appear to be repair-related");
//           // Still try AI analysis, it will return "other" if not repair
//         }

//         if (this.isConfigured) {
//           const result = await this.analyzeWithGoogleAI(extractedText);
...
//         // ✅ Check if this is a retry with the same image
//         if (extractedText === "") {
//           console.log(
//             "💡 Suggestion: Try re-selecting the image or use a different one",
//           );
//         }
//       }
...
//         console.log(`🖼️ Processing image ${i + 1}/${imageUrls.length}`);
